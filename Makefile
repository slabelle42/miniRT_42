...
SRCS += srcs/1_struct/rt_struct_7_ray_hit.c
SRCS += srcs/1_struct/rt_struct_8_scene.c
...
SRCS += srcs/3_image/rt_image_6_utils.c
SRCS += srcs/3_image/rt_image_objects/rt_image_sphere.c
